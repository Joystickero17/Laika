    ...
    <div id="aside" class="col-md-12">
						...
						<div class="aside">
							...
							<div class="checkbox-filter">
								...
								<div v-for="category in categories" :key=category.id class="input-checkbox">
						...
						<div class="aside">
							...
							<div class="price-filter">
								...
								<div class="input-number price-min">
									...
									<span @click="minPrice < 1 ? 1 : minPrice -= 1" class="qty-down">-</span>
								...
								<div class="input-number price-max">
									...
									<span @click="maxPrice < 1 ? 1 : maxPrice -= 1" class="qty-down">-</span>
								</div>
							</div>
						</div>
						<!-- /aside Widget -->
...
export default {
    ...
    data() {
		...
		watch:{
			minPrice(value){
				...
				state.updateMinPrice(value)
			}
			},
			maxPrice(value){
				this.$refs.priceslider.noUiSlider.set([null, value])
				state.updateMaxPrice(value)
			}
	...
	if (this.$refs.priceslider){
		...
		this.$refs.priceslider.noUiSlider.on('update', (values, handle) =>{
				...
				if (handle == 0){this.minPrice = parseInt(value)} else{this.maxPrice = parseInt(value)}  
